...
/*  object MAP_SPARQL_CUSTOM_FUNCTIONS extends Enumeration {
    type MAP_SPARQL_CUSTOM_FUNCTIONS = Value 
...
*/
  ...
  val SQL_LOGICAL_OPERATOR_PLUS = "PLUS";
  val SQL_LOGICAL_OPERATOR_PRIORTO = "PRIOR TO";
  ...
  val MAP_SPARQL_CUSTOM_FUNCTIONS = Map("http://www.w3.org/2001/XMLSchema#int" -> "TO_NUMBER", 
      "http://www.w3.org/2001/XMLSchema#float" -> "TO_NUMBER", "SUBSTR" -> "SUBSTR");
